...
@Weave
public abstract class KafkaRecordStreamingProcessorFacade {

	@Trace(dispatcher = true)
	private ProcessingResult processRecord(TopicPartition partition, boolean partitionHasNext, boolean recordHasNext, KafkaRecordStreamingProcessor kafkaRecordProcessor, ConsumerRecord<Object, Object> record) {
