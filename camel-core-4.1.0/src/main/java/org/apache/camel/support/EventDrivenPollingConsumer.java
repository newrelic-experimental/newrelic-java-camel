...
public abstract class EventDrivenPollingConsumer {
	...
	public Exchange receive() {
		...
		if(endPt != null) {
			...
			if(endpoint != null && !endpoint.isEmpty()) {
				NewRelic.getAgent().getTransaction().setTransactionName(TransactionNamePriority.FRAMEWORK_HIGH, false, "PollingConsumer", "EventDrivenPollingConsumer",endpoint);
			}
		}
